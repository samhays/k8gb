...
func (n *Ns1) ConfigureZoneDelegation() (r *reconcile.Result, err error) {
...
func (n *Ns1) coreDNSExposedIPs() ([]string, error) {
...
func (n *Ns1) ensureDNSEndpoint(namespace string, i *externaldns.DNSEndpoint) (*reconcile.Result, error) {
